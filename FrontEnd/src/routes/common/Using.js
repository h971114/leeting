        ...
        <div id="main_content">
            <div className="board_list">
                <div className="detail_content">
                    <h2 className="securityh2">이용 약관</h2>
                    <div className="top_box">이 약관은 'Leeting'(이하 "회사")에서 제공하는 커뮤니티 서비스 및 이에 부수된 제반 서비스(이하 "서비스")의 이용과 관련하여, 회사와 회원 간에 서비스 이용에 관한 권리 및 의무와 책임사항, 기타 필요한 사항을 규정하는 것을 목적으로 합니다.</div>
                    <h3 className="SsubTit">1. 약관의 게시와 효력, 개정</h3>
                    <ol className="number">
                        <li>(1) 회사는 서비스의 가입 과정에서 회원에게 본 약관을 제시하고, 서비스 홈페이지에 본 약관을 게시합니다.</li>
<li>                        
...
(4) 회사가 약관을 개정할 경우에는 개정약관 공지 후 개정약관의 적용에 대한 회원의 동의 여부를 확인합니다. 회원은 회사가 전항에 따라 변경하는 약관에 동의하지 않을 권리가 있으며, 이 경우 회원은 회사에서 제공하는 서비스 이용 중단 및 탈퇴 의사를 표시하고 서비스 이용 종료를 요청할 수 있습니다. 다만, 회사가 회원에게 변경된 약관의 내용을 공지하면서 회원에게 동의 또는 거부의 의사표시를 하지 않을 경우 승낙한 것으로 간주하겠다는 내용을 명확히 표시하였음에도 불구하고, 회원이 약관 시행일까지 거부의 의사표시를 하지 아니한 경우 회원이 변경된 약관에 동의하는 것으로 간주할 수 있습니다.</li>
                    </ol>
                    <h3 className="SsubTit">2. 약관의 해석과 예외 준칙</h3>
                    <ol className="number">
<li>
(1) 회사는 제공하는 개별 서비스에 대해서 별도의 이용약관 및 정책을 둘 수 있으며, 해당 내용이 이 약관과 상충할 경우 개별 서비스의 이용약관을 우선하여 적용합니다.
</li><li>
                            (2) 본 약관에 명시되지 않은 사항이 관계법령에 규정되어 있을 경우에는 그 규정에 따릅니다.</li></ol>
                    <h3 className="SsubTit">3. 용어의 정의</h3>
                    <ol className="number">
                        <li>(1) 서비스: 개인용 컴퓨터 (PC), TV, 휴대형 단말기, 전기통신설비 등을 포함한 각종 유무선 장치와 같이 구현되는 단말기와 상관없이 회원이 이용할 수 있는 커뮤니티 서비스 및 이에 부수된 제반 서비스를 의미합니다.</li>
                        <li>(2) 회원: 회사와 서비스 이용계약을 체결하고 회사가 제공하는 서비스를 이용하는 모든 사용자를 의미합니다.</li>
                        <li>
                        ...
                        <li>
                            (6) 계정 정보: 회원이 아이디, 비밀번호, 성명 등 회원이 회사에 제공한 일반정보 및 참여한 리팅 정보 등 생성정보를 통칭합니다.
                        </li>
                        <li>
                            (7) 게시물: 회원이 서비스를 이용함에 있어 회원이 서비스에 게시한 문자, 문서, 그림, 음성, 링크, 파일 혹은 이들의 조합으로 이루어진 정보 등 모든 정보나 자료를 의미합니다.
                        </li>
                    </ol>
                    <h3 className="SsubTit">4. 이용계약의 체결</h3>
                    <ol className="number">
<li>                        
...
(3) 회사는 이용약관에 동의한 후 이용 신청한 사용자에 대해서 원칙적으로 접수 순서에 따라 서비스 이용을 승낙함을 원칙으로 합니다. 다만 회사의 설비에 여유가 없거나 기술적 장애가 있는 경우, 서비스 상의 장애가 발생한 경우, 그 밖에 이용신청의 승낙이 곤란한 경우 일정시간 가입승인을 유보할 수 있습니다.
</li><li>
(4) 회사는 다음 각 호에 해당하는 신청에 대해서 승낙하지 않거나 사후에 이용계약을 해지할 수 있습니다.
</li><li>
...
⑦ 회원의 이용 목적이나 서비스 이용 방법이 회사의 재산권, 영업권을 침해할 우려가 있는 경우
</li><li>
⑧ 회원의 이용 목적이나 서비스 이용 방법이 다른 회원의 서비스 이용에 영향을 미칠 경우
</li><li>
⑨ 비정상적인 방법을 통하여 아이디 및 도메인을 대량으로 생성하는 행위
</li><li>
⑩ 정보통신망 이용촉진 및 정보보호 등에 관한 법률 및 그 밖의 관계 법령에서 금지하는 위법행위를 할 목적으로 이용신청을 하는 경우
</li><li>
⑪ 그 밖에 1호 내지 10호에 준하는 사유로서 승낙이 부적절하다고 판단되는 경우
</li><li>
(5) 회사는 회원에 대해 회사정책에 따라 등급별로 구분하여 이용시간, 이용횟수, 서비스 메뉴 등을 세분하여 이용에 차등을 둘 수 있습니다.
</li><li>
(6) 회원은 회사에 언제든지 회원 탈퇴를 요청하여 이용계약을 해지할 수 있습니다.
</li><li>
(7) 회원은 회원 가입이나 회원정보 수정을 통해 기재한 개인정보 및 모든 정보의 내용에 변경이 발생한 경우, 즉시 변경사항을 정정하여 기재하여야 합니다. 변경의 지체로 인하여 발생한 회원의 손해에 대해 회사는 책임을 지지 않습니다.
</li><li>
(8) 회사는 관련 법률 및 회사의 개인정보처리방침에서 정한 바에 따라 회원에게 요청하는 회원정보 및 기타정보 항목을 추가, 삭제 등 변경하여 수집 및 이용할 수 있습니다.</li>
                    </ol>
                    <h3 className="SsubTit">5. 개인정보보호 의무</h3>
                    <ol className="number">
                        <li>
...
(3) 회사는 서비스를 이용하는 회원으로부터 제기되는 불만이 정당하다고 인정할 경우, 시스템과 인력이 충분하다면 이를 처리하여야 합니다. 이 처리과정에 대해서 회원이 작성한 문의에 답변하는 방법으로 전달하거나, 서비스에 반영함으로써 회원은 이를 인지 할 수 있습니다.
</li><li>
(4) 회사는 정보통신망 이용촉진 및 정보보호에 관한 법률, 통신비밀보호법, 전기통신사업법 등 서비스의 운영, 유지와 관련 있는 법규를 준수합니다.
                        </li>           </ol>
                    <h3 className="SsubTit">8. 회원의 의무</h3>
                    <ol className="number">
                        <li>(1) 회원은 다음 각호에 해당하는 행위를 해서는 안 됩니다.
</li><li>
...
(6) 회사는 회원이 게시하거나 등록하는 서비스 내의 게시물, 게시 내용이 제1항에서 규정하는 금지행위에 해당된다고 판단되는 경우, 사전통지 없이 이를 삭제하거나 이동 또는 등록을 거부할 수 있습니다.</li>
                    </ol>
                    <h3 className="SsubTit">
                        9. 서비스의 제공 및 변경
                    </h3>
...
(5) 전항에 의해서 제공되는 서비스가 변경 및 중단될 경우 무료로 제공되는 서비스 이용과 관련하여 이용자에게 발생한 어떠한 손해에 대해서도 책임을 지지 않습니다. 다만, 회사의 고의 또는 중대한 과실로 인하여 발생한 손해의 경우는 제외합니다.
                    ...
                    <h3 className="SsubTit">10. 게시물의 삭제 또는 이용 제한</h3>
                    <ol className="number">
                        <li>(1) 회원의 공개게시물의 내용이 다음 각 호에 해당하는 경우 회사는 해당 게시물을 삭제 또는 해당 회원의 회원 자격을 제한, 정지 또는 상실시킬 수 있습니다.
                        </li><li>
...
(2) 회원의 공개게시물로 인한 법률상 이익 침해를 근거로, 다른 회원 또는 제3자가 회원 또는 회사를 대상으로 하여 민형사상의 법적 조치(예: 고소, 가처분신청, 손해배상청구소송)를 취하는 동시에 법적 조치와 관련된 게시물의 삭제를 요청해오는 경우, 회사는 동 법적 조치의 결과(예: 검찰의 기소, 법원의 가처분결정, 손해배상판결)가 있을 때까지 관련 게시물에 대한 접근을 잠정적으로 제한하거나 수정, 삭제 권한을 임시로 제한할 수 있습니다.</li>
                    </ol>
<h3 className="SsubTit">11. 광고의 게재</h3>
...
<h3 className="SsubTit">
12. 전자우편을 통한 정보의 제공</h3>
<ol className="number"><li>
(1) 회사는 회원이 서비스 이용에 필요하다고 인정되는 다양한 정보를 회원이 제공한 전자우편 주소로 제공할 수 있습니다.
</li><li>
(2) 회사는 다음 각호에 해당하는 경우 회원의 동의여부와 상관없이 전자우편으로 발송할 수 있습니다.
</li><li>
① 이용 신청에서 입력한 전자우편 주소의 소유를 확인하기 위해서 인증메일을 발송하는 경우
</li><li>
② 기타 서비스를 제공함에 있어 회원이 반드시 알아야 하는 중대한 정보라고 회사가 판단하는 경우
</li><li>
③ 아이디/비밀번호 분실로 인한 정보 찾기 기능을 이용하여 인증메일을 발송하는 경우 (단, 가입 신청한 회원 본인 뿐 아니라 누구든지 이 기능으로 인증메일 발송을 요구 할 수 있음)
</li></ol>
...
③ 회사의 서비스를 홍보하기 위한 목적으로 미디어, 통신사 등에게 게시물의 내용을 보도, 방영하게 하는 것. 단, 이 경우 회사는 회원의 개별 동의 없이 미디어, 통신사 등에게 게시물 또는 회원정보를 제공하지 않습니다.
</li><li>
